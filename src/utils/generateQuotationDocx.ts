  ...
  const doc = new Document({
    sections: [{
      ...
      children: [
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  ...
                  children: [new Paragraph({ alignment: AlignmentType.RIGHT, children: [new TextRun({ text: "2,000", bold: true, size: 20, font: "Calibri" })] })],
                }),
              ],
            }),
          ],
        ...
        bodyText("All amounts are in Bahraini Dinar and exclusive of any applicable taxes."),
