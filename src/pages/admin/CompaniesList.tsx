...
const CompaniesList = () => {
  ...
  const handleSave = async () => {
    ...
    const selected = companiesData.find((x) => x.id === selectedRows[0]);
              ...
              <div className="space-y-3 md:border-r border-gray-100 last:border-0 pr-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    <span className="font-semibold text-gray-900 truncate max-w-[180px] text-left w-32 shrink-0">
                      User Code:
                    </span>
                    <span
                      className="font-semibold text-purple-700 bg-purple-50/50 px-1.5 py-0.5 rounded truncate max-w-[180px] md:max-w-[200px] text-left"
                      title={currentContext.userCode}
                    >
              ...
              <div className="space-y-3 md:border-r border-gray-100 last:border-0 pr-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    ...
                    <span
                      className="font-semibold text-purple-700 bg-purple-50/50 px-1.5 py-0.5 rounded truncate max-w-[180px] md:max-w-[200px] text-left"
                      title={currentContext.companyCode}
                    >
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <span
                      className="font-semibold text-purple-700 bg-purple-50/50 px-1.5 py-0.5 rounded truncate max-w-[180px] md:max-w-[200px] text-left"
                      title={currentContext.companyName}
                    >
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-sm">
                    ...
                    <span
                      className="font-semibold text-purple-700 bg-purple-50/50 px-1.5 py-0.5 rounded truncate max-w-[180px] md:max-w-[200px] text-left"
                      title={currentContext.locationCode}
                    >
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <span
                      className="font-semibold text-purple-700 bg-purple-50/50 px-1.5 py-0.5 rounded truncate max-w-[180px] md:max-w-[200px] text-left"
                      title={currentContext.locationName}
                    >
