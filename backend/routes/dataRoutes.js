...
router.post("/Diet_Plans_hdrLoopInsert", dataController.Diet_Plans_hdrLoopInsert)
router.post("/Diet_Plans_hdrLoopUpdate", dataController.Diet_Plans_hdrLoopUpdate)
router.post("/Diet_Plans_hdrLoopDelete", dataController.Diet_Plans_hdrLoopDelete)
...
router.post("/Diet_Plans_MealsLoopInsert", dataController.Diet_Plans_MealsLoopInsert)
router.post("/Diet_Plans_MealsLoopUpdate", dataController.Diet_Plans_MealsLoopUpdate)
router.post("/Diet_Plans_MealsLoopDelete", dataController.Diet_Plans_MealsLoopDelete)
